...
- [ ] Update `src/hiveforge/steering/workflows/init_workflow.py`
...
- [ ] Update `tests/test_init_workflow.py`
...
- [ ] Update `src/hiveforge/steering/shared/adapters.py`
...
- [ ] Update `src/hiveforge/steering/parsers/orchestrator.py`
...
- [ ] Update `tests/test_document_parser_orchestrator.py`
  - Test file type filtering
...
- [ ] Update `hiveforge-power/mcp_server/tools/init_steering.py`
...
- [ ] Update `src/hiveforge/steering/cli.py`
  - Add `--dry-run` flag to `init` command
  - Pass flag to workflow
  - Display preview results
- [ ] Update `tests/test_steering_cli.py`
...
- [ ] Update Step 2.2 "Use KIRO IDE + Steering Assistant Agent"
...
- [ ] Add "Terminology" section (NEW - Red Team Recommendation)
...
- [ ] Update all MCP tool docstrings
...
- [ ] Create `tests/integration/test_custom_source_path.py`
...
- [ ] Create `tests/integration/test_empty_source_warnings.py`
...
- [ ] Update `hiveforge-power/tests/test_mcp_tools.py`
...
- [ ] Create `tests/integration/test_rollback_new_components.py`
...
- [ ] Test source discovery with 10,000+ files
...
- [ ] Verify atomic operations work with new components
...
- [ ] Create `tests/performance/test_confidence_performance.py`
...
- [ ] Create `tests/performance/test_tagging_performance.py`
  - Benchmark tagging on 10KB file (target: < 1ms)
  - Benchmark tagging on 100KB file (target: < 10ms)
  - Benchmark tagging on 1MB file (target: < 100ms)
  - Set performance assertions in tests

### 6.6.3 Source Discovery Benchmarks
- [ ] Create `tests/performance/test_discovery_performance.py`
...
- [ ] Create `docs/migration-v2.2.0.md` (NEW - Red Team Required)
...
- [ ] Add v2.2.0 features to feature list
...
### 7.6 Manual Testing
- [ ] Test scenario 1: User with docs in `_DEVELOPMENT/`
  - Create test project
...
- [ ] Test scenario 2: User with empty `.kiro/onboarding/`
  ...
  - Verify low confidence metadata
- [ ] Test scenario 3: User running dry-run
  - Create test project
